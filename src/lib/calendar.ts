import { addDaysStr, compareDateStr, endOfMonthStr, endOfWeekSat, startOfMonthStr, startOfWeekMon, startOfWeekSun } from "./date";
...
/** Mon-Sun dates of the week `anchor` falls in — the week view starts on Monday, unlike the month grid, which starts on Sunday. */
